...
class AgentExecutor:
    ...
    def __init__(
        self, agent: BaseAgent, project_config: ProjectConfig, event_loop_manager: Optional[EventLoopManager] = None
    ):
    ...
    def _signal_handler(self, signame: Optional[str] = None) -> None:
