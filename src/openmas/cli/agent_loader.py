...
class AgentLoader:
    ...
    def load_agent_class(self, agent_module_path: str, expected_class_name: Optional[str] = None) -> Type[BaseAgent]:
    ...
    def _find_agent_class(
        self, agent_module: types.ModuleType, expected_class_name: Optional[str] = None
    ) -> Type[BaseAgent]:
