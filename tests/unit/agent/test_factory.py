...
class TestAgentFactory:
    ...
    def test_create_custom_agent_from_config(self):
        ...
        config = {"agent_id": "test_agent", "name": "Test Agent", "type": "custom"}
    ...
    def test_create_agent_unknown_type(self):
        ...
        factory = AgentFactory()
        config = {"agent_id": "test_agent", "name": "Test Agent"}
...
class TestDefaultFactory:
    ...
    def test_create_agent_from_config_convenience(self):
        ...
        config = {"agent_id": "convenience_agent", "name": "Convenience Agent"}
