...
class TestMCPMessageTranslator:
    ...
    def test_mcp_error_to_simf(self):
        ...
        assert simf_message.payload.error_message == "Tool not found"
        assert simf_message.payload.error_details["data"]["tool_name"] == "missing_tool"
...
class TestMCPProtocolAdapter:
    ...
    @patch('src.openmas.protocols.mcp.adapter.MCP_AVAILABLE', False)
