...
class MockMcpCommunicator:
    ...
    async def start(self):
        ...
        if hasattr(self, "agent") and self.agent is not None:
            # Register tools
            for _tool_name, tool_data in self.agent._tools.items():
            ...
            # Register prompts
            for _prompt_name, prompt_data in self.agent._prompts.items():
            ...
            # Register resources
            for _resource_uri, resource_data in self.agent._resources.items():
