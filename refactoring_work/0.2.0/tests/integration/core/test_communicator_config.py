...
def test_env_specific_port_configuration(multi_agent_project):
    ...
    with open(multi_agent_project / "openmas_project.yml") as f:
    ...
    if "communicator_defaults" in project_config and "options" in project_config["communicator_defaults"]:
...
def test_communicator_type_selection(mcp_styled_project):
    ...
    with open(mcp_styled_project / "openmas_project.yml") as f:
        config = yaml.safe_load(f)
