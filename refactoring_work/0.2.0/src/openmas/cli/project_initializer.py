...
class ProjectInitializer:
    ...
    def __init__(
        self, project_path: Path, project_display_name: str, template: str | None = None, poetry: bool = False
    ) -> None:
    ...
    def _prepare_file_actions(self) -> dict[Path, str | Callable[[], str]]:
        ...
        """
        actions: dict[Path, str | Callable[[], str]] = {}
...
'''
        ...
        if self.template and self.template.lower() == "mcp-server":
