...
def _load_project_config(project_dir: Path | None = None) -> dict:
...
def list_prompts(agent: str | None = None, project_dir: Path | None = None) -> None:
...
def render_prompt(agent_name: str, prompt_name: str, variables: list[str], project_dir: Path | None = None) -> None:
