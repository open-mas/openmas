...
class AgentTestHarness(Generic[T]):
    ...
    def __init__(
        ...
        communicator_class: type[Any] | None = None,
        communicator_kwargs: dict[str, Any] | None = None,
        agent_init_kwargs: dict[str, Any] | None = None,
        default_asset_manager: AssetManager | None = None,
    ):
    ...
    async def trigger_handler(self, agent: T, method: str, params: dict[str, Any] | None = None) -> Any:
