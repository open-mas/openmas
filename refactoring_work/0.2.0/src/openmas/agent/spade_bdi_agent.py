...
class SpadeBDIAgentBase:
    ...
    def get_belief(self, *args: Any, **kwargs: Any) -> Any | None:
        return None
...
class SpadeBdiAgent(BdiAgent):
    ...
    def __init__(
        ...
        self._spade_bdi_agent: SpadeBDIAgentBase | None = None
    ...
    async def update_beliefs(self) -> None:
        ...
        if self._spade_bdi_agent:
            ...
            for _belief_name, _belief_value in self._beliefs.items():
