...
class McpServerAgent(McpAgent):
    ...
    def setup_communicator(self, instructions: str | None = None) -> None:
    ...
    async def start_server(self, instructions: str | None = None) -> None:
    ...
    async def wait_until_ready(self, timeout: float = 5.0) -> bool:
        ...
        while (asyncio.get_event_loop().time() - start_time) < timeout:
            if self.communicator._server is not None:
                return True
