...
class DependencyError(OpenMasError):
    ...
    def __init__(self, message: str, dependency: str, extras: str | None = None) -> None:
...
class CommunicationError(OpenMasError):
    ...
    def __init__(self, message: str, target: str | None = None, details: dict[str, Any] | None = None) -> None:
