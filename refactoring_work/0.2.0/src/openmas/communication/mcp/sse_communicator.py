...
class McpSseCommunicator(BaseCommunicator):
    ...
    def __init__(
        ...
        **kwargs: Any,  # Accept any additional kwargs for flexibility
        ...
        self.fastmcp_server: Any | None = None
    ...
    async def send_request(
        ...
        response_model: type[T] | None = None,  # response_model not used by MCP, kept for compatibility
        timeout: float | None = None,  # timeout handled by asyncio.wait_for
    ) -> Any:
    ...
    async def _run_fastmcp_server(self) -> None:
        ...
        try:
            ...
            for _name, tool_info in self.tool_registry.items():
    ...
    async def list_tools(self, target_service: str, timeout: float | None = None) -> list[dict[str, Any]]:
