...
class McpStdioCommunicator(BaseCommunicator):
    ...
    def __init__(
        ...
        service_args: dict[str, list[str]] | None = None,  # Args per service
    ) -> None:
    ...
    async def send_request(
        ...
        response_model: type[T] | None = None,  # Ignored for MCP
    ...
    async def _handle_mcp_request(
        self, method: str, params: dict[str, Any] | None = None, target_service: str | None = None
    ) -> Any | None:
