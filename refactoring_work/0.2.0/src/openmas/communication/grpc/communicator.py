...
try:
    from openmas.communication.grpc import (
        openmas_pb2 as pb2,  # type: ignore[attr-defined]
        openmas_pb2_grpc as pb2_grpc,  # type: ignore[attr-defined]
    )
except ImportError:
...
class GrpcCommunicator(BaseCommunicator):
    ...
    async def stop(self) -> None:
        ...
        for _service, channel in self._channels.items():
            await channel.close()
