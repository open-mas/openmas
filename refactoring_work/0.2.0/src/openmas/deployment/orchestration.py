...
class ComposeOrchestrator:
    ...
    def save_compose_to_file(self, compose_config: dict[str, Any], output_path: str | Path) -> Path:
    ...
    def save_compose(self, components: list[DeploymentMetadata], output_path: str | Path) -> Path:
