...
class DockerSpec(BaseModel):
    ...
    build: DockerBuildSpec | None = Field(None, description="Docker build configuration")
    image: str | None = Field(None, description="Docker image to use instead of building")
...
class EnvironmentVar(BaseModel):
    ...
    value: str | None = Field(None, description="Value of the environment variable")
...
class DeploymentMetadata(BaseModel):
    ...
    resources: ResourceSpec | None = Field(None, description="Resource requirements")
    health_check: HealthCheckSpec | None = Field(None, description="Health check configuration")

    @classmethod
    def from_file(cls, file_path: str | Path) -> "DeploymentMetadata":
    ...
    def get_environment_value(self, name: str) -> str | None:
