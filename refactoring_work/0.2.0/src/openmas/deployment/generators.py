...
class DockerComposeGenerator:
    ...
    def save(self, metadata: DeploymentMetadata, output_path: str | Path) -> Path:
...
class KubernetesGenerator:
    ...
    def _create_deployment(self, metadata: DeploymentMetadata, image: str) -> dict[str, Any]:
        ...
        for _i, volume_spec in enumerate(metadata.volumes):
    ...
    def save(self, metadata: DeploymentMetadata, output_dir: str | Path) -> list[Path]:
