# Knowledge Access for Hybrid Reasoning Engines

## Overview

This document outlines how the standardized knowledge access interfaces support hybrid reasoning engines in OpenMAS. Hybrid reasoning engines combine multiple reasoning paradigms to leverage their complementary strengths, and they require flexible knowledge access mechanisms that can accommodate different knowledge representation needs. The interfaces defined in this directory are designed to provide a consistent access layer regardless of the underlying reasoning approach.
