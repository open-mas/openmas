...
# Protocol imports (aligned with design structure)
from openmas.protocols import (
    A2AProtocolInterface,
    MCPProtocolInterface,
    HTTPProtocolInterface,
)

# Communication patterns imports
from openmas.communication_patterns import (
...
# Topology imports (aligned with design structure)
from openmas.topology import (
    CentralizedTopology,
    DecentralizedTopology,
    HybridTopology,
)

# Public exports (aligned with design structure)
__all__ = [
    "load_configuration",
    "Agent",
    "AgentCapabilities",
